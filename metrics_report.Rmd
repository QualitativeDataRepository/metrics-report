...
# Calculate dates
period_begin <- as.Date("2021-01-01")
period_end <- as.Date("2021-12-31")
...
- Manually specified extensions: `r extension_names`
...
deposits %>% filter(!is.na(member) & as.Date(createdAt) > period_end) %>% 
  ...
  knitr::kable(caption=paste("Deposits between", period_begin, 
                             "and", period_end),
               col.names = c("Institution", "Status", "Deposits"))
