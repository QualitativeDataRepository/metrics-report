...
checkif_member <- function(login, extension=NULL) {
  institutions <- structure(list(name = c("American", "Brown", "Case Western", 
                                          ...
                                          "Marine Corps", "New York", "Palliative Care Research Cooperative", 
                                          "Princeton", "Syracuse", "California, Berkeley", "California, Merced", "California, San Francisco",
                                          "Cincinnati", "Iowa", "Maryland, Baltimore", "Michigan, Ann Arbor", 
                                          "New Mexico", "North Carolina, Chapel Hill", "University of Pennsylvania", "Texas, Austin", 
                                          "Villanova", "Virginia Tech", "West Virginia"), 
                                 domain = c("american.edu", 
                                            "brown.edu", "case.edu", "columbia.edu", "cornell.edu", "duke.edu", 
                                            "fordham.edu", "gmu.edu", "gwu.edu", "usmcu.edu", 
                                            "nyu.edu", "palliativecareresearch.org", "princeton.edu", 
                                            "syr.edu", "berkeley.edu", "ucmerced.edu", "ucsf.edu", "uc.edu", "uiowa.edu", 
                                            "umaryland.edu", "umich.edu", "unm.edu", "unc.edu", "upenn.edu", "utexas.edu", 
